<div class="flex min-h-screen flex-col justify-between border-x border-x-rose-400"
    wire:id="dashboard">
    <div>
        <div
            class="sticky top-0 z-10 flex w-full flex-col gap-4 bg-gray-400 bg-opacity-10 px-4 py-4 font-bold backdrop-blur">
            <!-- <svg height="30" width="30" style="enable-background:new 0 0 40 40;" version="1.1" viewBox="0 0 512 512" -->
        ...
        <div class="flex flex-col pb-4">
            @foreach ($chirps as $chirp)
                <livewire:chirps.chirp :chirp="$chirp" wire:key="{{ $chirp->id }}" />
            @endforeach
        </div>
    </div>
